...
// next cycle.
reg is_split;
// is_retry: whether the next response is RETRY and should degrant bus in
// next cycle.
reg is_retry;
...
always @ (posedge HCLK or negedge HRESETn) begin
  if(!HRESETn) begin
    ...
    case(HBURST) 
      `HBURST_SINGLE: is_fixed_length <= 1'b1;
  ...
  if(HTRANS == `HTRANS_NONSEQ) begin
    ...
    // Else, reset the count
      ...
      case(HBURST)
        ...
        `HBURST_INCR16: next_count = 6'h10;
      endcase
    end // :if(READY) else
